...
public class Eliminar_Material extends javax.swing.JFrame {
    ...
    public Eliminar_Material() throws SQLException {
        initComponents();
        mostrarMaterial();
    ...
    private void btnEliminarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMousePressed
        try {
            ...
            LogManager.getLogger(Eliminar_Material.class.getName()).warn(ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Eliminar_Material.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new Eliminar_Material().setVisible(true);
                } catch (SQLException ex) {
                    LogManager.getLogger(Eliminar_Material.class.getName()).warn(ex);//log(Level.SEVERE, null, ex);
                }
            }
        });
    }
