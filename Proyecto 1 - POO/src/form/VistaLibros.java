...
public class VistaLibros extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblLIB.setFont(new java.awt.Font("Century", 0, 12)); // NOI18N
        ...
        lblCD.setText("Libros- Biblioteca");
    ...
    private void btnUpdateMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMousePressed
        try{
            ...
            if(this.tblLIB.getSelectionModel().isSelectionEmpty()){
                ...
                int linea = this.tblLIB.getSelectedRow();
                int modelRow = tblLIB.convertRowIndexToModel(linea);
                String s = tblLIB.getModel().getValueAt(modelRow, 0)+"";
    ...
    public void  EditarLibros() throws SQLException{
        ...
        try{
            ...
            tblLIB.setModel(new DefaultTableModel(
        list,
        new String [] {
