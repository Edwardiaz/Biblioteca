...
public class VistaTesis extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblTES.setFont(new java.awt.Font("Century", 0, 12)); // NOI18N
        tblTES.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tblTES);
    ...
    private void btnUpdateMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMousePressed
        try{
            ...
            if(this.tblTES.getSelectionModel().isSelectionEmpty()){
                ...
                int linea = this.tblTES.getSelectedRow();
                int modelRow = tblTES.convertRowIndexToModel(linea);
                String s = tblTES.getModel().getValueAt(modelRow, 0)+"";
    ...
    public void  EditarTESIS() throws SQLException{
        ...
        try{
            ...
            tblTES.setModel(new DefaultTableModel(
        list,
        new String [] {
    ...
    private javax.swing.JTable tblTES;
